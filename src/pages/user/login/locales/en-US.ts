export default {
    'userandlogin.login.userName': 'account',
    ...
    'userandlogin.login.tab-login-credentials': 'Account Login',
    'userandlogin.login.tab-login-mobile': 'Mobile Phone Login',
    'userandlogin.login.remember-me': 'Auto Login',
    'userandlogin.login.forgot-password': 'Forgot password need administrator',
    ...
    'userandlogin.userName.wrong-format': 'The account is in the wrong format, please use email or phone number',
    'userandlogin.password.required': 'Please enter your password!',
    'userandlogin.password.invalid-length': 'The password entered need at least 8 chars and no more than 20 chars!',
